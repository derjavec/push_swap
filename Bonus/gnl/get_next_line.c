...
static t_lst	*ft_remplir_list(char *content, t_lst *list)
{
	int			letters;
	static char	*node;
	int			i;
...
static void	ft_copy_list_to_line(char *content, t_lst **list, int content_size)
{
	int		i;
	int		j;
	t_lst	*temp;
...
static t_lst	*ft_point_stock(t_lst **list)
{
	t_lst	*temp;
...
static char	*ft_list_to_line(t_lst **list, char *line, int content_size)
{
